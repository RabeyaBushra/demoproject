                ...
                <div class="row">
                    ...
                    <div class="col-xl-2 col-lg-3 col-md-4 sidebar fixed-top">
                        ...
                        <ul class="menu-ul flex-column mt-4">
                            <li class="nav-item"><a href="StaffDashboard.php" class="nav-link text-white p-2 mb-1 sidebar-link current"><i
                            ...
                            <li class="nav-item"><a href="Staffprofile.php" class="nav-link text-white p-2 mb-1 sidebar-link"><i
